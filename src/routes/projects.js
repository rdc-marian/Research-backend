...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    const items = await ResearchProject.find(query)
...
router.post(
  ...
  asyncHandler(async (req, res) => {
    ...
    const item = await ResearchProject.create(data);
...
router.get(
  "/:id",
  asyncHandler(async (req, res) => {
    const item = await ResearchProject.findById(req.params.id)
      .populate("scholar", "name email researchCenter guide")
      .populate("verifiedBy", "name email");
...
router.patch(
  ...
  asyncHandler(async (req, res) => {
    ...
    const item = await ResearchProject.findByIdAndUpdate(req.params.id, update, {
      new: true,
      runValidators: true,
    }).populate("scholar", "name email researchCenter guide");
